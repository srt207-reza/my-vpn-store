            ...
            <div className="flex flex-col items-center justify-center space-y-6">
                    ...
                    <div className="flex flex-col gap-6">
                        ...
                        <div className="w-full pt-4 border-t border-slate-700/40">
                            <RubberVolumeSlider
                                ...
                                onChange={(val: number) => setFormData({ ...formData, volume: val })}
                            />
                        </div>
                    </div>
                </div>
                ...
                >
                    <div className="flex justify-between items-center text-sm mb-1.5">
                        ...
                        <span className={`font-bold text-lg ${themeColor} flex items-baseline gap-1`}>
                            <MorphingText value={formData.volume.toLocaleString("fa-IR")} />
                            <span>گیگابایت</span>
                        </span>
                    </div>
                    ...
                    <div className="flex justify-between items-center text-sm">
                        ...
                        <MorphingText value={durationLabel} className={`font-bold text-lg ${themeColor}`} />
                    </div>
