...
function OrderForm() {
    ...
    // قرار دادن مقدار استخراج شده به عنوان مقدار پیش‌فرض حجم
    ...
    const totalPrice = formData.volume * PRICE_PER_GB;
                    ...
                    <div className="flex items-center justify-center gap-2 mt-6">
                        {[1, 2, 3].map((num) => (
                            <div key={num} className="flex items-center">
                                <div
                                    className={`w-8 h-8 rounded-full flex items-center justify-center text-sm font-bold transition-colors ${step >= num ? "bg-primary text-slate-900" : "bg-slate-800 text-slate-400"}`}
                                >
                                    {num}
                                </div>
                                {num < 3 && (
                    ...
                    >
                        ...
                        <div className="bg-slate-900/60 rounded-2xl p-6 space-y-5 border border-slate-700/50">
                            <div className="flex justify-between items-center text-sm">
                                ...
                                <span className="text-white font-bold bg-slate-800 px-3 py-1 rounded-lg">ترافیک اتصال بین‌الملل</span>
                            </div>
                            <div className="flex justify-between items-center text-sm">
                ...
                {step === 4 && (
                    ...
                    >
                        ...
                        <p className="text-slate-400">
                            کد پیگیری سفارش: <span className="font-mono text-primary bg-primary/10 px-3 py-1 rounded-lg ml-1 border border-primary/20">{orderId}</span>
                        </p>

                        <div className="bg-gradient-to-br from-slate-800 to-slate-900 p-6 md:p-8 rounded-3xl border border-slate-700 relative overflow-hidden mt-8 text-left shadow-2xl">
                            ...
                            <div className="relative z-10 space-y-5">
                                <p className="text-slate-300 text-sm text-right leading-relaxed">
                                    جهت دریافت ترافیک، لطفاً مبلغ <strong className={`text-lg ${themeColor}`}>{totalPrice.toLocaleString("fa-IR")} تومان</strong> را به کارت زیر واریز نمایید:
                                </p>
                                
                                <div className="flex items-center justify-between bg-black/40 p-4 md:p-5 rounded-2xl backdrop-blur-sm border border-slate-700/50 shadow-inner">
                                ...
                                <div className="flex justify-between items-center text-sm">
                                    ...
                                    <span className="text-white font-medium bg-slate-800 px-3 py-1 rounded-lg">مائده شعاعی (بانک ملی)</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="bg-slate-800/40 p-6 rounded-3xl border border-slate-700 space-y-5 mt-6">
                            <p className="text-slate-300 text-sm leading-relaxed text-justify">
                                پس از واریز وجه، روی دکمه زیر کلیک کنید و <strong className="text-primary">تصویر رسید پرداختی</strong> را به همراه <strong className="text-white">کد پیگیری</strong> در تلگرام برای ما ارسال کنید تا کانفیگ شما در سریع‌ترین زمان ممکن صادر شود.
                            </p>
                            <a
                                href={supportLink}
                                target="_blank"
